    ...
    <div className="flex min-h-screen">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-violet-600 to-indigo-700 flex-col justify-between p-12">
        ...
        <div>
          ...
          <p className="text-violet-200 text-base">Free forever. No credit card required.</p>
        </div>
        <p className="text-violet-300 text-sm">© {new Date().getFullYear()} ProjectFlow</p>
      </div>
      ...
      <div className="flex flex-1 items-center justify-center px-6 py-12 bg-slate-50">
        <div className="w-full max-w-sm">
          <div className="mb-8">
            ...
            <p className="mt-1 text-sm text-slate-500">Get started in seconds, it&apos;s free</p>
          </div>
